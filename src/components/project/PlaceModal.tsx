  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg w-full max-w-3xl h-4/5 flex flex-col">
        ...
        <div className="mb-2">
          <button
            className={`mr-2 px-4 py-2 rounded-full text-xs font-medium hover:bg-cyan-500 hover:text-white transition-colors duration-200 items-center shadow-sm ${activeTab === 'recommended' ? 'bg-cyan-500 text-white' : 'bg-white text-cyan-500 border border-cyan-500'}`}
            onClick={() => setActiveTab('recommended')}
          >
            추천 장소
          </button>
          <button
            className={`px-4 py-2 rounded-full text-xs font-medium hover:bg-cyan-500 hover:text-white transition-colors duration-200 items-center shadow-sm ${activeTab === 'search' ? 'bg-cyan-500 text-white' : 'bg-white text-cyan-500 border border-cyan-500'}`}
        ...
        <div className="mt-4 w-full flex justify-end">
          <button
            className="px-4 py-2 bg-cyan-500 text-white rounded hover:bg-cyan-900 text-sm"
            onClick={onClose}
          >
            닫기
          </button>
